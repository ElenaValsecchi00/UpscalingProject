...
class ImageUploaderAppStack(core.Stack):
    ...
    def __init__(self, scope: core.Construct, construct_id: str, **kwargs) -> None:
        ...
        image_uploader_lambda = _lambda.Function(
            self, 'image-uploader-function',
        ...
        image_api = _apigw.RestApi(
            self, 'image-uploader-api',
        ...
        image_model = image_api.add_model(
            'ImageRequest',
        ...
        image_api.root.add_resource("image").add_method(
            "post", image_lambda_integration,
